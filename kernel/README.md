...
kernel を利用するリポジトリは、`.claude/settings.json` でツール許可を設定する必要がある。
...
```bash
kernel/scripts/orchestrator/watch-logs.sh             # 全 Worker
kernel/scripts/orchestrator/watch-logs.sh 4           # 特定 Worker
```
