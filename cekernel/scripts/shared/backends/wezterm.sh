#!/usr/bin/env bash
# backends/wezterm.sh — WezTerm terminal backend
#
# Implements terminal_* functions using WezTerm CLI.
# Sourced by terminal-adapter.sh when CEKERNEL_TERMINAL=wezterm.
