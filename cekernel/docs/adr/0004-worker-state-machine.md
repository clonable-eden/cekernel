...
- `worker-status.sh` lists Workers by enumerating FIFOs in the IPC directory. It reports issue number, worktree path, and uptime — but not what the Worker is *doing*.
